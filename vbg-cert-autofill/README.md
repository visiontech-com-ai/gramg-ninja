# GramG Ninja (Chrome / Edge)

*Certificate Auto-Fill · report export & join · wage-list caste breakup · Work Demand bulk autofill — for the VB-G RAM G portal.*
...
**caste-wise wage-list amount breakup** — see **§5** below — plus a
**Work Demand bulk autofill** that enters a whole Excel sheet of demands for
you — see **§6**.
...
> address bar and **pin** “GramG Ninja”. (You can also open
...
2. The blue **“GramG Ninja · Certificate Auto-Fill”** panel appears at the top-right and shows
...
## 6. Work Demand bulk autofill (from an Excel sheet)

On the **Work Demand** page (`demand_new.aspx`) the add-on can enter a whole
sheet of demands for you. Keep your data in Excel with these columns (header
names are matched loosely, any order):

| Reg No | Applicant | Work From | No of Days |
|--------|-----------|-----------|------------|
| WB-06-003-006-001/009 | Sunil Mandi | 07-09-2026 | 3 |
| WB-06-003-006-001/010 | Bijendranath Kisku | 07-09-2026 | 3 |

**Date of Application** is set to **today** automatically (your sheet doesn’t need
it), and **Work Demand To** is computed by the portal from *From + No of Days*.

### How to use
1. Open the **Work Demand** page and log in as usual.
...
> dropdowns, that row is flagged so you can fix the selection and Resume.

> This *does* submit demands to the portal (via its own **Proceed** button). Review
> the sheet before clicking Start, and use **Stop** at any time.
...
- **SheetJS / xlsx** (`xlsx.full.min.js`) — Apache License 2.0 — reads the Work
  Demand `.xlsx` and writes the exported results file.

All run fully offline; they are used only to re-render oversized scans and to read
and write spreadsheets locally in your browser.
