...
A **Chrome / Edge** add-on for the **VB-G RAM G** portal. It fills all **8 certificate blocks** on the
...
Application Register), a **caste-wise wage-list amount breakup** shown right on
the wage-list page, and a **Work Demand bulk autofill** that enters a whole Excel
sheet of demands on the Work Demand page. Everything runs in the browser.

- **Download:** see the [latest release](https://github.com/visiontech-com-ai/vbgramg-cert-uploader/releases/latest) or the
  [project page](https://visiontech-com-ai.github.io/gramg-ninja/).
- **Install & use guide:** [illustrated guide](https://visiontech-com-ai.github.io/gramg-ninja/vbg-cert-autofill/install-guide.html)
...
- **Work Demand bulk autofill.** On the Work Demand page, pick an Excel sheet
  (`Reg No · Applicant · Work From · No of Days`) and the add-on selects each
  registration, fills the demand, and clicks *Proceed* for you. Date of
  Application defaults to today. It **resumes** long sheets after any interruption,
  auto-accepts the portal’s confirmation, and can **export** a results copy.
